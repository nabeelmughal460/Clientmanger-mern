...
export const calculateProfit = async (projectId, userId) => {
    try {
        ...
        const effectiveRate = actualHours > 0 ? project.agreedPrice / actualHours : 0;
        const scopeCreep = project.estimatedHours > 0
